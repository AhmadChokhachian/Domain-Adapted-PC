...
DETAIL_FILE  = RESULTS_DIR / f"Table2_G_XGBoost_detail{year_suffix}.csv"
SUMMARY_FILE = RESULTS_DIR / f"Table2_G_XGBoost_summary{year_suffix}.csv"
...
def run():
    ...
    print(f"[INFO] Starting G_XGBoost — {n_targets} targets x {len(TEST_YEARS)} years", flush=True)
