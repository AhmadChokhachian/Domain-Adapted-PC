...
"C:\Users\achokhachian3\AppData\Local\Programs\R\R-4.5.2\bin\Rscript.exe" "code\Table4(STGP).R"
...
>"%OUTDIR%\table4_stgp_runtime.txt" echo %stgp_runtime%

:: =========================
:: NN
:: =========================
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set start=%%i
python -m jupyter nbconvert --to notebook --execute "code\Table4(NN).ipynb" --inplace
if errorlevel 1 goto :error
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set end=%%i
set /a nn_runtime=%end%-%start%
echo NN runtime (sec): %nn_runtime%
>"%OUTDIR%\table4_nn_runtime.txt" echo %nn_runtime%
...
:: =========================
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set start=%%i
python -m jupyter nbconvert --to notebook --execute "code\Table4(BNN).ipynb" --inplace
if errorlevel 1 goto :error
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set end=%%i
set /a bnn_runtime=%end%-%start%
echo BNN runtime (sec): %bnn_runtime%
>"%OUTDIR%\table4_bnn_runtime.txt" echo %bnn_runtime%
...
:: =========================
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set start=%%i
python -m jupyter nbconvert --to notebook --execute "code\Table4(XGBoost).ipynb" --inplace
if errorlevel 1 goto :error
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set end=%%i
set /a xgb_runtime=%end%-%start%
echo XGBoost runtime (sec): %xgb_runtime%
>"%OUTDIR%\table4_xgboost_runtime.txt" echo %xgb_runtime%

:: =========================
:: twinGP + Binning
:: =========================
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set start=%%i
"C:\Users\achokhachian3\AppData\Local\Programs\R\R-4.5.2\bin\Rscript.exe" "code\Table4(twinGP+Binning).R"
if errorlevel 1 goto :error
for /f %%i in ('powershell -NoProfile -Command "[int][double](Get-Date -UFormat %%s)"') do set end=%%i
set /a twingp_runtime=%end%-%start%
echo twinGP+Binning runtime (sec): %twingp_runtime%
>"%OUTDIR%\table4_twinGP_binning_runtime.txt" echo %twingp_runtime%
...
>"%OUTDIR%\table4_python_update_runtime.txt" echo %python_runtime%
...
>"%OUTDIR%\table4_total_runtime.txt" echo %total_runtime%
...
echo.
echo Table 4 finished successfully.
pause
exit /b 0
